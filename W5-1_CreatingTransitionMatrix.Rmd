---
title: "W5-1_CreatingTransitionMatrix"
...
**OBJECTIVE:**
- Creating segmentation transition matrix
- Making a model to calculate Customer Lifetime Value (CLV)
...
To calculate the customer lifetime value, multiply the trans_matrix table by the multiplier table. The result shown below.
